...
interface ExerciseRepository {
    ...
    // Historial Detallado por Serie
    fun getDetailedHistoryByDaySlot(daySlotId: String): Flow<List<DetailedHistory>>
    fun getAllDetailedHistory(): Flow<List<DetailedHistory>>
    suspend fun insertDetailedHistory(history: DetailedHistory)
    suspend fun updateDetailedHistory(history: DetailedHistory) // NUEVA FUNCIÓN
